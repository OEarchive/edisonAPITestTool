...
public class PopUpMenuCopyTotalSavingsTableToClipboard extends JPopupMenu {

    public PopUpMenuCopyTotalSavingsTableToClipboard(java.awt.event.MouseEvent evt, final JTable table) {
