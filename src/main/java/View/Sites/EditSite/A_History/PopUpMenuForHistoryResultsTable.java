...
public class PopUpMenuForHistoryResultsTable extends JPopupMenu {

    public PopUpMenuForHistoryResultsTable(java.awt.event.MouseEvent evt, final JTable table) {
