...
public class ReportPointsTableCellRenderer extends DefaultTableCellRenderer {

    final Color limeGreen;

    public ReportPointsTableCellRenderer() {
    ...
    public Component getTableCellRendererComponent(
        ...
        EnumDatpointListTableColumns enumCol = EnumDatpointListTableColumns.getColumnFromColumnNumber(column);
        this.setHorizontalAlignment((enumCol == EnumDatpointListTableColumns.Value ) ? JLabel.RIGHT : JLabel.LEFT);
