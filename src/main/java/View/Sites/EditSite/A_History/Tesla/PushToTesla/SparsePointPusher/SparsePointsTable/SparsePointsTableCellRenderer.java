...
public class SparsePointsTableCellRenderer extends DefaultTableCellRenderer {

    final Color limeGreen;

    public SparsePointsTableCellRenderer() {
    ...
    public Component getTableCellRendererComponent(
        ...
        EnumSparsePointsTableColumns enumColumn = EnumSparsePointsTableColumns.getColumnFromColumnNumber(column);
        SparsePointsTableModel model = (SparsePointsTableModel) table.getModel();
        int modelIndex = table.convertRowIndexToModel(row);
        SparseTableRow mappedRow = model.getRow(modelIndex);
