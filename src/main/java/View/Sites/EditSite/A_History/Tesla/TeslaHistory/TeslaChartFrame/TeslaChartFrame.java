...
package View.Sites.EditSite.A_History.Tesla.TeslaHistory.TeslaChartFrame;
...
public class TeslaChartFrame extends javax.swing.JFrame implements PropertyChangeListener {

    private final OptiCxAPIController controller;
    private final int maxPoints;
    private final DateTimeZone timeZone;

    public TeslaChartFrame( OptiCxAPIController controller, TeslaStampsAndPoints sp, int maxPoints, DateTimeZone timeZone) {
        initComponents();
        ...
        ChartPanel CP = getChart(sp.getTimeStampsAsStrings(), sp.getPointsMap());
