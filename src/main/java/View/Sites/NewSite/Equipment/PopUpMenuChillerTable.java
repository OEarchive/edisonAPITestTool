...
public class PopUpMenuChillerTable extends JPopupMenu {

    public PopUpMenuChillerTable(java.awt.event.MouseEvent evt, final JTable table) {
        ...
        item.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (selectedRowIndicies != null && selectedRowIndicies.length > 0) {
                    ChillerTableModel mod = (ChillerTableModel) table.getModel();
