...
public class PopUpMenuHeatExchangers extends JPopupMenu {

    public PopUpMenuHeatExchangers(java.awt.event.MouseEvent evt, final JTable table) {
        ...
        item.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (selectedRowIndicies != null && selectedRowIndicies.length > 0) {
                    HeatExchangersTableModel mod = (HeatExchangersTableModel) table.getModel();
