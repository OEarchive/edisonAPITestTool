...
public class CarnotFour_SiteTwo_Template {
    
    private final Site site;
    
    public CarnotFour_SiteTwo_Template( String customerSid, String extSfId, String siteName){
        
        Map<EnumChillerTypes, Integer> chillerTypesAndCounts = new HashMap<>();
        chillerTypesAndCounts.put( EnumChillerTypes.mcquay, 3 );
