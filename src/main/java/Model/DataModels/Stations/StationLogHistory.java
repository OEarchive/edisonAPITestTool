...
public class StationLogHistory {
    ...
    @JsonProperty("data")
    private List<StationAuditLogData> data;
    ...
    public List<StationAuditLogData> getData() {
        return data;
    }

    @JsonIgnore
    public void setData(List<StationAuditLogData> data) {
        this.data = data;
    }
}
