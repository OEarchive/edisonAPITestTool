...
package Model.DataModels.TeslaModels.CSVMaker;
...
public class CSVMaker {
    ...
    private final ComboHistories history;

    public CSVMaker(String filePath, ComboHistories history) {
    ...
    public boolean makeCSV() {
        ...
        try {
            ...
            String header = "timestamp," + String.join(",", history.getFlatPointNames());
            writer.write(header);
            writer.newLine();
            ...
            for (DateTime timeStamp : history.getTimestamps()) {
                ...
                List<Object> values = history.getFlatTimestampsToValuesMap().get(timeStamp);
