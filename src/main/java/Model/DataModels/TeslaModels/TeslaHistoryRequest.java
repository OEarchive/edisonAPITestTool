...
public class TeslaHistoryRequest {
    ...
    public TeslaHistoryRequest() {

    }

    @JsonIgnore
    public TeslaHistoryRequest(List<String> ids, DateTime startAt, DateTime endAt, String resolution, String timeZone) {
