...
import Model.DataModels.CSVMaker.EdisonCSVMaker;
...
// ==== TRENDAPI =======
    ...
    public void createEdisonCSV( final String filePath, final int prec, final List<String> uNames, final List<String> timestamps, final Map< String, Map<String, Object>> timestampToUNameValueMap ) {
        ...
        SwingWorker worker = new SwingWorker< OEResponse, Void>() {
            ...
            public OEResponse doInBackground() throws IOException {
                ...
                EdisonCSVMaker csvMaker = new EdisonCSVMaker(filePath, prec, uNames, timestamps, timestampToUNameValueMap);
                boolean flag = csvMaker.makeCSV();
            ...
            public void done() {
                try {
                    ...
                    if (resp.responseCode == 200) {
                        ...
                        pcs.firePropertyChange(PropertyChangeNames.EdisonCSVCreated.getName(), null, flag);
                    } else {
                        pcs.firePropertyChange(PropertyChangeNames.ErrorResponse.getName(), null, resp);
                    }
                    pcs.firePropertyChange(PropertyChangeNames.RequestResponseChanged.getName(), null, getRRS());
